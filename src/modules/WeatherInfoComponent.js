...
// destructuring the weather using props
...
const WeatherComponent = (props) => {
    const {weather} = props;
      ...
      // there will be alphabe d if there is day
    ...
    return (
        <>
            <WeatherContainer>
                ...
                {/* for taking before decimal value only we take math.floor */}
            ...
            {/* (?.)this is using optional chaining */}
